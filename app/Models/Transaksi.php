...
class Transaksi extends Model
{
    ...
    protected $table = 'transaksis'; // (Opsional) Tambahkan ini jika nama tabelmu 'transaksis'
    ...
    // Ini sangat penting untuk Tugas 3 agar format tanggal otomatis dibaca sebagai Carbon (bisa dihitung selisih harinya)
    protected $casts = [
        'tanggal_pinjam' => 'date',
