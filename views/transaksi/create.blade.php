                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body bg-white text-dark">
                            <form action="{{ route('transaksi.store') }}" method="POST">
                                ...
                                {{-- Pilih Anggota --}}
                                <div class="mb-3">
                                    <label for="anggota_id" class="form-label font-bold">Pilih Anggota <span class="text-danger">*</span></label>
                                ...
                                {{-- Pilih Buku --}}
                                <div class="mb-3">
                                    <label for="buku_id" class="form-label font-bold">Pilih Buku <span class="text-danger">*</span></label>
                                ...
                                {{-- Tanggal Pinjam --}}
                                <div class="mb-3">
                                    <label for="tanggal_pinjam" class="form-label font-bold">Tanggal Pinjam <span class="text-danger">*</span></label>
                                ...
                                {{-- Keterangan --}}
                                <div class="mb-3">
                                    <label for="keterangan" class="form-label font-bold">Keterangan</label>
